...
export class fixDate1616280971134 implements MigrationInterface {
    name = 'fixDate1616280971134'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `user_details` CHANGE `updated_at` `updated_at` timestamp(0) NOT NULL DEFAULT ''0000-00-00 00:00:00''");
